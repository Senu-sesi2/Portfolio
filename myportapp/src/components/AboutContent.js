    ...
    <div className="about">
      <div className="left">
        ...
        <div className="btn-container">
          <a href={ResumePDF} download="Emmanuel_Senu_Mensah_Resume.pdf">
      ...
      <div className="right">
        <div className="img-container">
          <div className="img-stack top">
            <img src={Rt1} className="img" alt="screenshot of react" />
          </div>
          <div className="img-stack bottom">
            <img src={Rt2} className="img" alt="screenshot of react" />
          </div>
        </div>
      </div>
    </div>
